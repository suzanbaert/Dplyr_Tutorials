...
In the sample code below I'm searching for the string "Ca" across all columns. I want to keep rows where the string "Ca" is present in ANY of the variables, so I will wrqp the condition in `any_vars()`.  
