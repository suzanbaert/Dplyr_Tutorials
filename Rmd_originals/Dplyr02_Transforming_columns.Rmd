...
Or as [Tomas McManus](https://twitter.com/TomasMcManus1/status/981187099649912832) pointed out: you can assign new column names inside `funs()`. In the main difference between both options: the `funs()` version is one line of code less, but columns will be added, rather than replaced. Depending on your scenario, both can be useful.
